...
use \app\nucleo\{Config};
use \app\modelos\instrumentos\CalificarBDIBECK;

class ObtenerBDIBECK
{
	private $_db,
			$_count,
			$_result,
	...
	)
	{
		...
		$this->_calificar = $CalificarBDIBECK;
	}
	...
	public function obtener(int $id)
	{
		$datos = $this->_db->obtener(
			...
			(
				...
				'desde' => array(
					$this->_config->obtener('dbnombres/depresion') => 'BDIBECK'
				),
				'join' => array(
