...
class ObtenerDatosDeFormatosDeSeleccionYPreseleccion
{
	private $_db,
			$_count,
			$_result,
	 ...
	 * @return false
	 */
	protected function formatos(string $table,$id,array $columnas,string $nombre): bool
	{
		//BUSCAR EN LA TABLA
		$datos = $this->_db->get(
			array(
	 ...
	 * @return false
	 */
	protected function entrevista($id): bool
	{
		$tablas =  array(
		...
		if(isset($entrevista) && count($entrevista)  == 8)
		{
