...
use \app\modelos\pacientes\RegistrarConvenioPeriodico;
use \app\nucleo\Config;
/**
 * 
 */
class RevisarConvenioPeriodico
{
	private 	$_validar,
				$_redirigir,
				$_campos,
	...
	)
	{
		...
		$this->_campos = require_once 'app/libreria/comprobacion/RevisarConvenioPeriodico.php';
