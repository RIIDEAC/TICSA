...
use \app\modelos\consejeria\RegistrarPLANINDIVIDUAL;
use \app\nucleo\Config;
/**
 * 
 */
class RevisarConsejeriaPLANINDIVIDUAL
{
	private 	$_validar,
				$_redirigir,
				$_campos,
	...
	(
		...
		Redirigir $Redirigir,
		Entrada $Entrada,
		RegistrarPLANINDIVIDUAL $RegistrarPLANINDIVIDUAL,
		Config $Config
	...
	)
	{
		...
		$this->_campos = require_once 'app/libreria/comprobacion/RevisarConsejeriaPLANINDIVIDUAL.php';
		$this->_entrada = $Entrada;
		$this->_satisf = $RegistrarPLANINDIVIDUAL;
		$this->_config = $Config;
	}
