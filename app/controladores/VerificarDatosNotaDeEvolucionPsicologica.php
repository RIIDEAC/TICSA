...
use \app\modelos\paciente\RegistrarNotaDeEvolucionPsicologica;
/**
 * 
 */
class VerificarDatosNotaDeEvolucionPsicologica
{
	private $_post,
			$_redirigir,
			$_token,
	...
	(
		...
		Redirigir $Redirigir, 
		Token $Token,
		RegistrarNotaDeEvolucionPsicologica $RegistrarNotaDeEvolucionPsicologica
	)
	{
		$this->_post = $Post;
		$this->_redirigir = $Redirigir;
		$this->_token = $Token;
		$this->_nota = $RegistrarNotaDeEvolucionPsicologica;
		$this->Comprobacion();
	}

	public function Index(): void
	{
		if($this->_nota->registrar($this->_post))
		{
