...
use \app\modelos\consejeria\RegistrarNotaIndividual;
use \app\nucleo\Config;
/**
 * 
 */
class RevisarConsejeriaNotaIndividual
{
	private 	$_validar,
				$_redirigir,
				$_campos,
	...
	)
	{
		...
		$this->_campos = require_once 'app/libreria/comprobacion/RevisarConsejeriaNotaIndividual.php';
