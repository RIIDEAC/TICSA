...
use \app\modelos\consejeria\RegistrarSCL90;
use \app\nucleo\Config;
/**
 * 
 */
class RevisarConsejeriaSCL90
{
	private 	$_validar,
				$_redirigir,
				$_campos,
	...
	)
	{
		...
		$this->_campos = require_once 'app/libreria/comprobacion/RevisarConsejeriaSCL90.php';
		$this->_entrada = $Entrada;
		$this->_scl = $RegistrarSCL90;
		$this->_config = $Config;
	}
