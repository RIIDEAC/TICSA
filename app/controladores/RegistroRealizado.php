...
class RegistroRealizado
{
	...
	{
		if(!isset($_SESSION[$this->_config->obtener('sesion/realizado')]))
		{
			$this->_redirigir->a($this->_config->obtener('dir/principal'));
		}
		$this->_vista->ver('plantilla/Header');
		$this->_menu->ver();
		$this->_vista->ver('plantilla/RegistroRealizado');
		$this->_vista->ver('plantilla/Footer');
		unset($_SESSION[$this->_config->obtener('sesion/realizado')]);
	}
}