...
use \app\modelos\paciente\RegistrarAsignarConsejero;
/**
 * 
 */
class VerificarDatosAsignarConsejero
{
	private $_post,
			$_redirigir,
			$_token,
	...
	(
		...
		Redirigir $Redirigir, 
		Token $Token,
		RegistrarAsignarConsejero $RegistrarAsignarConsejero
	)
	{
		$this->_post = $Post;
		$this->_redirigir = $Redirigir;
		$this->_token = $Token;
		$this->_assist = $RegistrarAsignarConsejero;
		$this->Comprobacion();
	}
