...
use \app\modelos\consejeria\RegistrarBECKBDI;
use \app\nucleo\Config;
/**
 * 
 */
class RevisarConsejeriaBECKBDI
{
	private 	$_validar,
				$_redirigir,
				$_campos,
	...
	(
		...
		Redirigir $Redirigir,
		Entrada $Entrada,
		RegistrarBECKBDI $RegistrarBECKBDI,
		Config $Config
	...
	)
	{
		...
		$this->_campos = require_once 'app/libreria/comprobacion/RevisarConsejeriaBECKBDI.php';
		$this->_entrada = $Entrada;
		$this->_bdi = $RegistrarBECKBDI;
		$this->_config = $Config;
	}
