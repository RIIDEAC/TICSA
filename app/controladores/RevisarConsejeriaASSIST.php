...
use \app\modelos\consejeria\RegistrarASSIST;
use \app\nucleo\Config;
/**
 * 
 */
class RevisarConsejeriaASSIST
{
	private 	$_validar,
				$_redirigir,
				$_campos,
	...
	)
	{
		...
		$this->_campos = require_once 'app/libreria/comprobacion/RevisarConsejeriaASSIST.php';
	...
	public function Index()
	{
		...
		if(!$this->_validar->entrada($_POST, $this->_campos)->fails())
		{
			...
			if($this->_assist->registrar($_POST))
			{
