...
use \app\modelos\consejeria\RegistrarBECKBAI;
use \app\nucleo\Config;
/**
 * 
 */
class RevisarConsejeriaBECKBAI
{
	private 	$_validar,
				$_redirigir,
				$_campos,
	...
	(
		...
		Redirigir $Redirigir,
		Entrada $Entrada,
		RegistrarBECKBAI $RegistrarBECKBAI,
		Config $Config
	...
	)
	{
		...
		$this->_campos = require_once 'app/libreria/comprobacion/RevisarConsejeriaBECKBAI.php';
		$this->_entrada = $Entrada;
		$this->_bai = $RegistrarBECKBAI;
		$this->_config = $Config;
	}
