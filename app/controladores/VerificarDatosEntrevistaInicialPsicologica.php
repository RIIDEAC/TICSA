...
use \app\modelos\paciente\RegistrarEntrevistaInicialPsicologica;
/**
 * 
 */
class VerificarDatosEntrevistaInicialPsicologica
{
	private $_post,
			$_redirigir,
			$_token,
	...
	(
		...
		Redirigir $Redirigir, 
		Token $Token,
		RegistrarEntrevistaInicialPsicologica $RegistrarEntrevistaInicialPsicologica
	)
	{
		$this->_post = $Post;
		$this->_redirigir = $Redirigir;
		$this->_token = $Token;
		$this->_convenio = $RegistrarEntrevistaInicialPsicologica;
		$this->Comprobacion();
	}
