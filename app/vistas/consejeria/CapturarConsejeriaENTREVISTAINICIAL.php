<div class="jumbotron">
    <div class="container">
        ...
        <form method="POST" action="<?php echo $this->_config->obtener('app/webbase'); ?>RevisarConsejeriaENTREVISTAINICIAL/">
          <div class="form-row">
...
<script>
  function cargarEI()
      {
        ...
        $.ajax({
            data: data,
            url: '<?php echo $this->_config->obtener('app/webbase').'ControladorENTREVISTAINICIAL'; ?>',
            type: 'POST',
            beforeSend: function()
            {
  ...
  function actualizarTOKEN()
  {
    ...
    $.ajax({
            data: TOKEN,
            url: '<?php echo $this->_config->obtener('app/webbase').'ControladorENTREVISTAINICIAL/Token'; ?>',
            type: 'POST',
            success: function(response)
            {
