  <div class="container">
    ...
    <p></p>
    <form method="POST" action="<?php echo $this->_config->obtener('app/webbase'); ?>VerificarDatosNotaDeEvoluacionGrupalConsejeria/">
      <div class="form-row">
        <div class="form-group col-md-6">
          <label for="NING_ID"><h3>Pacientes</h3></label>
            <select data-live-search="true" id="NING_ID" name="NING_ID[]" class="form-control selectpicker" multiple required>
