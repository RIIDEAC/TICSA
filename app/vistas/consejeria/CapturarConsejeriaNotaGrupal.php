<div class="jumbotron">
  <div class="container">
    <h1 class="display-3">Registrar Nota de evolución grupal</h1>
    <p></p>
    <form method="POST" action="<?php echo $this->_config->obtener('app/webbase'); ?>RevisarConsejeriaNotaGrupal/">
      <div class="form-row">
        <div class="form-group col-md-6">
          <label for="NING_ID"><h3>Pacientes</h3></label>
            <select data-live-search="true" id="NING_ID" name="NING_ID[]" class="form-control selectpicker" multiple data-live-search="true" required>
      ...
      <div class="form-row">
      <div class="form-group col-md-12">
        <label>Aspectos que se trabajaron con el grupo durante la sesión (temas, acciones específicas):</label>
        <textarea class="form-control" maxlength="255" rows="3" name="ASPECTOS" required></textarea>
      </div>
      </div>
      <div class="form-row">
      <div class="form-group col-md-12">
        <label>Resultados de la sesión de consejería (conducta que mostró el grupo y su disposición):</label>
        <textarea class="form-control" maxlength="255" rows="3" name="RESULTADOS" required></textarea>
      </div>
      </div>
      <div class="form-row">
      <div class="form-group col-md-12">
        <label>Tareas que debe realizar el grupo:</label>
        <textarea class="form-control" maxlength="255" rows="3" name="TAREAS" required></textarea>
      </div>
      </div>
      <div class="form-row">
      <div class="form-group col-md-12">
        <label>Temas/contenidos a trabajar con el grupo en la próxima sesión (Plan de consejería grupal):</label>
