...
<header>
	...
	<title>Resultados prueba BDI:BECK</title>
</header>
<body>
	<textarea name="Editor">
		<table border="1" cellpadding="1" cellspacing="1" style="height:100%; width:100%">
			<tbody>
				...
				<tr>
					...
					<h3><strong>BDI:BECK para molestia en s&iacute;ntomas de depresión</strong></h3>
					</td>
					<td>C&oacute;digo:</td>
				</tr>
			</tbody>
		...
		<h4>En relación al suicidio refiere: <strong><?php echo $datos->RESULTADOS->ESPECIAL->SUICIDIO; ?></strong></h4>
		<hr>
