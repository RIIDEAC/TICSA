...
<header>
	...
	<title>Entrevista Inicial - Datos Generales</title>
</header>
<body>
	<textarea name="Editor">
		<table border="1" cellpadding="1" cellspacing="1" style="height:100%; width:100%">
			<tbody>
				...
				<tr>
					...
					<h3><strong>Entrevista Inicial - Datos Generales</strong></h3>
					</td>
					<td>Código: FA-01</td>
				</tr>
				<tr>
		...
		<?php } ?>	
		<hr>
		Salario mensual: <strong><?php echo $datos->FORMATO->SALARIO; ?> pesos</strong> Tiempo trabajando en el empleo actual (en meses): <strong><?php echo $datos->FORMATO->EMPLEO; ?> meses</strong><br>
		¿Se encuentra desempleado actualmente? <strong><?php echo $datos->RESULTADOS->DESEMPLEADO; ?></strong><br>
		¿Depende económicamente de alguién? <strong><?php echo $datos->RESULTADOS->DEPENDE; ?></strong><br>
		¿Alguién depende económicamente de usted? <strong><?php echo $datos->RESULTADOS->DEPENDIENTES; ?></strong><br>
		Personas con las que vive: <strong><?php echo $datos->RESULTADOS->VIVE; ?></strong><br>
	</textarea>
    <script>
