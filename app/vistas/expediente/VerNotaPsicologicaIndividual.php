...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
  <h1 class="h2">Nota de evolución psicológica individual</h1>
</div>
...
<table border="1" cellpadding="1" cellspacing="1" style="height:100%; width:100%">
		...
		<h3>Temas/contenidos a trabajar con el usuario en la próxima sesión (Plan de psicológia individual):</h3>
