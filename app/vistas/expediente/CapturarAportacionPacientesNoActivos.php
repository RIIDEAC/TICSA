...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
  <h1 class="h2">Capturar aportación pacientes Egresados</h1>
</div>
    <div class="container">
        <p class="text-justify"><strong>INTRUCCIONES:</strong> Este apartado es para capturar las aportaciones de pacientes que se encuentran egresados, si desea recibir una aportación para otro proceso del mismo paciente como un adeudo elija la opción adecuada.</p>
            ...
            <div class="form-group col-md-12">
              <label for="TIPO_APORTACION">Tipo de aportación:</label>
                <select data-live-search="true" id="TIPO_APORTACION" name="TIA_ID" class="form-control" required>
                 	<?php foreach ($datos->CATALOGOS->CAT_TIPOAPORTACION_TIA as $key => $value) { ?>
