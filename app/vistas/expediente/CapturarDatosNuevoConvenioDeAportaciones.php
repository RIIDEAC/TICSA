<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
  <h1 class="h2">Capturar nuevo convenio de aportaciones periódicas</h1>
</div>
<div class="container">
  <p><strong>INSTRUCCIONES:</strong> Registre un nuevo convenio de aportaciones periodicas en caso de que se haya llegado a un arreglo en la cantidad o la periodicidad de las aportaciones. A partir de la fecha de inicio que se registre se comenzará a contabilizar este nuevo convenio para realizar los balances de aportaciones. Puede registrar los convenios que sean necesarios.</p>
    <form method="POST" action="<?php echo $this->_config->obtener('app/webbase'); ?>VerificarDatosConvenioPeriodico/">
        <div class="form-row">
            ...
            <div class="form-group col-md-8">
                <label for="FECHA_CAPTURA"><h3>Fecha de inicio</h3> Es la fecha desde la cual será contado este convenio</label>
