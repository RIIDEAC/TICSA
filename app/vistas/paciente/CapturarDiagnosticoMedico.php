<div class="jumbotron">
  <div class="container-fluid">
    <h1 class="display-3">Registrar diagnóstico médico <small>CIE-10</small></h1>
    ...
    <form method="POST" action="<?php echo $this->_config->obtener('app/webbase'); ?>RevisarDiagnosticoMedico/">
      <div class="form-row">
