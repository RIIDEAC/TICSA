<?php //echo '<pre>'; print_r($datos); die(); ?>
  ...
  <h1 class="h2">Registrar familiar de paciente</h1>
</div>
  
    <p>Sólo se registran los datos una sola vez, aunque podrá editar los datos</p>
    <form method="POST" action="<?php echo $this->_config->obtener('app/webbase'); ?>VerificarDatosFamiliar/">
      <div class="form-row">
