<div class="jumbotron">
    <div class="container">
        <h1 class="display-3">Convenio de aportaciones <small>ingreso</small></h1>
        <p class="text-justify"><strong>INTRUCCIONES:</strong> Tenga en cuenta que sólo se puede registrar un convenio por expediente.</p>
        <form method="POST" action="<?php echo $this->_config->obtener('app/webbase'); ?>RevisarConvenioIngreso/">
            <div class="form-row">
...
{
    var items = ['CANTIDAD','MONEDA1','MONEDA2'];
    if(id == 'BECA2' && value == '2')
    {
