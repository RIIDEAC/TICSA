...
<div class="jumbotron">
  <div class="container">
    <h1 class="display-3">Registrar Nota de egreso</h1>
    <p>Sólo se permite egresar si el paciente tiene un expediente activo.</p>
    <form method="POST" action="<?php echo $this->_config->obtener('app/webbase'); ?>RevisarClinicoNotadeEgreso/">
      <div class="form-row">
        ...
        <div class="form-group col-md-4">
          <label for="PAC_TEGRESO">Tipo de egreso</label>
            <select data-live-search="true" id="PAC_TEGRESO" name="TIE_ID" class="form-control" required>
              <?php foreach ($this->_formatos->obtener('PAC_TEGRESO') as $key => $value) { ?>
      ...
      <div class="form-row">
        <div class="form-group col-md-12">
          ...
          <textarea class="form-control" id="PAC_ESTADO" name="PAC_ESTADO" maxlength="255" rows="3">Llenar en caso de que utilice los formatos del modelo de Ayuda Mutua</textarea>
        </div>
      </div>
      <div class="form-row">
