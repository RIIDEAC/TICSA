...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
  <h1 class="h2">Asigna o modifica el psicólogo(a) asignado al paciente</h1>
</div>
    <div class="container">
        <p class="text-justify"><strong>INTRUCCIONES:</strong> Este apartado es para asignar o modificar el psicólogo(a) de un paciente, si el paciente ya tiene psicólogo(a) asignado se modificará automaticamente</p>
        <form method="POST" action="<?php echo $this->_config->obtener('app/webbase'); ?>VerificarDatosAsignarPsicologo/">
            <div class="form-row">
            <div class="col-md-12">
                ...
                <div class="form-group col-md-12">
                  <label for="USU_ID"><h3>Psicólogo(a)</h3></label>
                    <select data-live-search="true" id="USU_ID" name="USU_ID" class="form-control" required>
                        <option>Selecciona el psicólogo(a)</option>
                      <?php foreach ($datos->PSICOLOGOS as $value) { ?>
